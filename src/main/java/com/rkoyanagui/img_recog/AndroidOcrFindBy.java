...
import com.rkoyanagui.img_recog.AndroidOcrFindBy.AndroidOcrFindByBuilder;
...
/**
 * Locates an element in a mobile Android device's screen, using the <i>OCR (Optical Character
 * Recognition)</i> method.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.FIELD)
@ImageTemplateFinder(AndroidOcrFindByBuilder.class)
public @interface AndroidOcrFindBy
{
  ...
  class AndroidOcrFindByBuilder extends
      OcrMatchingByBuilder<OcrMatchingBy, AndroidOcrFindByBuilder> implements
      ImgRecogByBuilderFromAnnotation<OcrMatchingBy>
  {

    public AndroidOcrFindByBuilder()
    {
      super();
    }

    @Override
    protected AndroidOcrFindByBuilder self()
    {
      return this;
    }
    ...
    {
      final AndroidOcrFindBy ann = (AndroidOcrFindBy) annotation;
