...
import com.rkoyanagui.img_recog.AndroidImageFeatureFindBy.AndroidImageFeatureFindByBuilder;
...
/**
 * Locates an image in a mobile Android device's screen, using the <i>feature matching</i> method.
...
@ImageTemplateFinder(AndroidImageFeatureFindByBuilder.class)
public @interface AndroidImageFeatureFindBy
{
  ...
  class AndroidImageFeatureFindByBuilder extends
      FeatureMatchingByBuilder<FeatureMatchingBy, AndroidImageFeatureFindByBuilder> implements
      ImgRecogByBuilderFromAnnotation<FeatureMatchingBy>
  {

    public AndroidImageFeatureFindByBuilder()
    {
      super();
    }

    @Override
    protected AndroidImageFeatureFindByBuilder self()
    {
      return this;
    }
    ...
    {
      final AndroidImageFeatureFindBy ann = (AndroidImageFeatureFindBy) annotation;
